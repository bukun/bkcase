...
tmpl = '''INSERT INTO "tabapp" ("uid", "title", "keywords", "desc", "industry", "date", "run_count", "view_count", "run_time", "update_time", "create_time", "type", "html_path", "cnt_md", "cnt_html", "memo", "lat", "lon", "zoom_max", "zoom_min", "zoom_current", "time_update") VALUES ('{0}', '新增地图标题', ' ', ' ', ' ', '2016-02-06 15:52:56', '0', '0', '0', '0', '0', '0', '0', ' ', ' ', ' ', '40', '105', '7', '4', '4', 0);
'''
...
all_maps = []
for wroot, wdirs, wfiles in os.walk(r'e:\maplet_dvk\MapPicDir_png'):
